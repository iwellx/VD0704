...
return array(
	...
	'DEFAULT_MODULE' => 'ApiService', // 默认模块
	...
	'SOFT_NAME'=>'车控宝企业后台',
	'SOFT_SITE'=>'http://120.27.200.37/vd_service/index.php?m=Admin&c=Index&a=index',
	'SOFT_BBS'=>'',
	'SOFT_VERSION'=>'1.0.1',
	'SOFT_AUTHOR'=>'福信富通',
	'SOFT_AUTHOR_QQ'=>'',
	'SOFT_AUTHOR_EMAIL'=>'',
	'SOFT_AUTHOR_SITE'=>'',
	'CLOUD_SHOP_SITE'=>'',//云商店地址

	/* 数据库设置 */
	'DB_TYPE' => 'mysql', // 数据库类型
	'DB_HOST' => '120.55.240.78', // 服务器地址
	'DB_NAME' => 'vd_test', // 数据库名
	'DB_USER' => 'root', // 用户名
	'DB_PWD' => 'fxft2017', // 密码
	'DB_PORT' => '3306', // 端口
	'DB_PREFIX' => 'ckb_', // 数据库表前缀
